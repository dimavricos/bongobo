...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    browserify: {
      options: {
        ...
        shim: {
          ...
          youtube: {
            path: 'assets/vendor/plugins/youtube.js',
            exports: 'tubeplayer'
          },

          ui : {
           path: 'assets/vendor/jquery-ui.min.js',
           exports: '$'
         },
        ...
        owlCarousel: {
          path: 'assets/vendor/plugins/owl.carousel.js',
          exports: 'owlCarousel'
        },

        scrollPane: {
          path: 'assets/vendor/plugins/scroll.pane.js',
          exports: 'jScrollPane'
        },

        mouseWheel: {
          path: 'assets/vendor/plugins/mouse.wheel.js',
          exports: '$'
        },
    ...
    "bootstrap": { 
      path: 'assets/vendor/lib/bootstrap.js',
      deps: [
      'jquery' 
      ],
      exports: '$.fn.popover'
